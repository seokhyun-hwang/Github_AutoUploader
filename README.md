...
**복잡한 Git 명령어는 이제 그만! 👋**<br>
GUI로 간편하게 파일을 관리하고, 자동으로 잔디를 심어주는 강력한 데스크톱 애플리케이션
...
<img src="https://github.com/user-attachments/assets/29f09aa8-ae8e-4cbe-bbbd-fd2ead800d9a" width="80%" alt="메인 실행 화면" />
